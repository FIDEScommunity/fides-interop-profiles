(function() {
  ...
  function openVocabularyModal(term, options) {
    ...
    const editActionHtml = buildVocabularyEditActionHtml(term, options);
    ...
    const modalHtml = '<div class="fides-modal-overlay fides-modal-overlay--vocabulary" id="fides-modal-overlay" data-theme="' + escapeHtml(theme) + '">' +
      ...
      '</div><div class="fides-modal-header-actions">' + editActionHtml + shareButtonHtml + '<button class="fides-modal-close" id="fides-modal-close" aria-label="Close modal">' + icons.xLarge + '</button></div></div>' +
      '<div class="fides-modal-body">' +
      '<div id="fides-modal-rating-slot" class="fides-modal-entity-like-slot"></div>' +
